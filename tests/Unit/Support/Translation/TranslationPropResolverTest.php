...
use App\Support\Translation\TranslationPropResolver;
...
class TranslationPropResolverTest extends TestCase
{
    ...
    #[Test]
    public function it_returns_an_empty_array_when_the_translation_key_does_not_resolve_to_an_array(): void
    {
        $this->translator->expects($this->once())
            ->method('get')
            ->with('home')
